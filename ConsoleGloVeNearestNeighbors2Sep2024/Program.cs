...
namespace ConsoleGloVeNearestNeighbors2Sep2024
{
    /// <summary>
    /// ChatGPT
    /// </summary>
    internal class Program
    {
        ...
        {
            const string filePath = "../../../../../../../GloVe/glove.6B.50d.txt";
            const int embeddingDimension = 50; // For example, GloVe's 50-dimensional embeddings
