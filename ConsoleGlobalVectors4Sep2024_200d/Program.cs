...
namespace ConsoleGlobalVectors4Sep2024_200d
{
    internal class Program
    {
        static void Main(string[] args)
        {
            string gloveFile = "../../../../../../../GloVe/glove.6B.200d.txt";
            ...
            Context Word: bright, Ratio: 1,3391
            Context Word: dark, Ratio: 0,9853
            Context Word: light, Ratio: 1,2543
            Context Word: fashion, Ratio: 2,3169
            Semantic ratios for words 'winter' and 'summer':
            Context Word: cold, Ratio: 1,3181
            Context Word: hot, Ratio: 0,9864
            Context Word: weather, Ratio: 1,3740
            Context Word: style, Ratio: 0,8298
            Semantic ratios for words 'dog' and 'cat':
            Context Word: bark, Ratio: 1,2943
            Context Word: meow, Ratio: 0,6836
            Context Word: pet, Ratio: 1,1012
            Context Word: fashion, Ratio: 1,1476
            Semantic ratios for words 'coffee' and 'tea':
            Context Word: caffeine, Ratio: 1,1674
            Context Word: herbal, Ratio: 0,6147
            Context Word: drink, Ratio: 1,0503
            Context Word: style, Ratio: 0,7788
            Semantic ratios for words 'car' and 'bicycle':
            Context Word: fuel, Ratio: 2,1232
            Context Word: pedal, Ratio: 0,8246
            Context Word: transport, Ratio: 1,0888
            Context Word: fashion, Ratio: 1,4820
            */
